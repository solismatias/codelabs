...
class Player extends SpriteGroupComponent<PlayerState>
  ...
  //  in Flame , down and right directions refer to the positive axis,
  //  and up and left refer to the negative axis. That's why the _gravity value is positive,
  //  instead of negative, and increasing the gravity pulls Dash down with a stronger effect.
